...
@HippoEssentialsGenerated(internalName = "visitscotland:TravelInformationArticle")
@Node(jcrType = "visitscotland:TravelInformationArticle")
public class TravelInformationArticle extends HippoCompound {
