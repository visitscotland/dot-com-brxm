...
public final class PageTemplateBuilder extends PageAssembler {
    ...
    public PageTemplateBuilder(DocumentUtilsService documentUtils, MegalinkFactory linksFactory, ICentreMapper iCentreFactory, IKnowMapper iKnowFactory, ArticleMapper articleMapper, LongCopyFactory longCopyFactory, UserGeneratedContentMapper userGeneratedContentFactory, TravelInformationMapper travelInformationMapper, CannedSearchFactory cannedSearchFactory, PreviewWarningMapper previewFactory, FormFactory marketoFormFactory, MapFactory mapFactory, SkiCentreListMapper skiCentreListMapper, SkiCentreMapper skiCentreMapper, SiteProperties properties, DevModuleMapper devModuleMapper, ResourceBundleService bundle, Logger contentLogger, SignpostFactory signPostFactory, EventsListingFactory eventsListingFactory) {
