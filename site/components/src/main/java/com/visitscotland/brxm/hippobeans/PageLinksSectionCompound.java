 ...
 */
@HippoEssentialsGenerated(internalName = "visitscotland:PageLinksSectionCompound")
@Node(jcrType = "visitscotland:PageLinksSectionCompound")
public class PageLinksSectionCompound extends HippoCompound {
