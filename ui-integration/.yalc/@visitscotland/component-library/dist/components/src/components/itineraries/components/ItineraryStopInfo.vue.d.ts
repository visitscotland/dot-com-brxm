declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    */
    ...
    hoursMessage(): string;
    provisionalMessage(): string;
}, {
    parseIncomingData(): void;
    getCurrentTime(): void;
    isActiveDate(): void;
    getCurrentHoursInfo(): void;
    compareTimes(currentTime: any, openingData: any, index: any): void;
    returnDayName(day: any): string;
    calculateClosingSoon(endTimeHours: any, endTimeMinutes: any): {
        hours: any;
        mins: number;
    };
    withinClosingSoonTime(currentTime: any, closingSoonTime: any): boolean;
