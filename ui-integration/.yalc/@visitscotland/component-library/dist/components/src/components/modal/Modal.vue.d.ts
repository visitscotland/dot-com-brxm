declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    BModal: {
        new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<Readonly<import('vue').ExtractPropTypes<{
            ...
            size: {
                type: import('vue').PropType<"xl" | keyof import('bootstrap-vue-next').BaseSize>;
                default: string;
            };
            lazy: {
                type: import('vue').PropType<boolean>;
            ...
            transProps: {
                type: import('vue').PropType<Readonly<import('bootstrap-vue-next').BTransitionProps>>;
                default: undefined;
            };
            autoFocus: {
                type: import('vue').PropType<boolean>;
            ...
            bodyTextVariant: {
                type: import('vue').PropType<keyof import('bootstrap-vue-next').BaseTextColorVariant | null>;
                default: null;
            };
            bodyVariant: {
                type: import('vue').PropType<keyof import('bootstrap-vue-next').BaseColorVariant | null>;
            ...
            close: (value: import('bootstrap-vue-next').BvTriggerableEvent) => void;
            cancel: (value: import('bootstrap-vue-next').BvTriggerableEvent) => void;
            ...
            ok: (value: import('bootstrap-vue-next').BvTriggerableEvent) => void;
        }, import('vue').PublicProps, {
            title: string;
            id: string;
            body: string;
            size: "xl" | keyof import('bootstrap-vue-next').BaseSize;
            lazy: boolean;
            noFade: boolean;
            ...
            bodyClass: any;
            headerClass: any;
            transProps: Readonly<import('bootstrap-vue-next').BTransitionProps>;
            autoFocus: boolean;
            autoFocusButton: "close" | "cancel" | "ok";
            backdropVariant: keyof import('bootstrap-vue-next').BaseColorVariant | null;
            bodyAttrs: Readonly<import('node_modules/bootstrap-vue-next/dist/src/types').AttrsValue>;
            ...
            bodyVariant: keyof import('bootstrap-vue-next').BaseColorVariant | null;
            busy: boolean;
            buttonSize: keyof import('bootstrap-vue-next').BaseSize;
            cancelDisabled: boolean;
            cancelTitle: string;
            cancelVariant: keyof import('bootstrap-vue-next').BaseButtonVariant | null;
            centered: boolean;
            contentClass: any;
            dialogClass: any;
            ...
            headerCloseVariant: keyof import('bootstrap-vue-next').BaseButtonVariant | null;
            ...
            okOnly: boolean;
            okTitle: string;
            okVariant: keyof import('bootstrap-vue-next').BaseButtonVariant | null;
            scrollable: boolean;
            titleClass: any;
            titleSrOnly: boolean;
            titleTag: string;
