declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    */
    ...
    hasFeaturedItem(): import('vue').VNode<import('vue').RendererNode, import('vue').RendererElement, {
        [key: string]: any;
    }>[];
    hasFeaturedItemLeft(): import('vue').VNode<import('vue').RendererNode, import('vue').RendererElement, {
        [key: string]: any;
    }>[];
    hasFeaturedEvent(): import('vue').VNode<import('vue').RendererNode, import('vue').RendererElement, {
        [key: string]: any;
    }>[];
    alignmentClass(): "" | "vs-mega-nav-dropdown-container__featured--bottom";
    ...
    */
    ...
    VsMegaNavDropdown: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
        menuToggleAltText: {
            type: StringConstructor;
            required: true;
        };
    ...
    }, import('vue').ComponentOptionsMixin, "menuToggled"[], "menuToggled", import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<{
        menuToggleAltText: {
            type: StringConstructor;
            required: true;
        };
    }>> & Readonly<{
        onMenuToggled?: (...args: any[]) => any;
    }>, {}, {}, {
        BDropdown: {
