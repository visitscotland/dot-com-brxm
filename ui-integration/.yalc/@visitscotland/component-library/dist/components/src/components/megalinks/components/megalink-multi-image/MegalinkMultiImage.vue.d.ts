declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    */
    ...
    multiImageClasses(): (string | {
        'vs-megalink-multi-image-card--featured': boolean;
        'vs-megalink-multi-image-card--featured-last': boolean;
    })[];
    ...
    */
    ...
    VsStretchedLinkPanels: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
        days: {
            type: StringConstructor;
            default: string;
        };
