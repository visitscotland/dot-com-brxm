declare const _default: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    */
    ...
    trackShareClick(event: any): void;
}, {
    computed: {
        pageUrl: () => string;
    };
...
}, import('vue').ComponentOptionsMixin, "copyLinkClicked"[], "copyLinkClicked", import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<{
    /**
    * Type of link and icon to display
    */
    name: {
    ...
    */
    ...
    onCopyLinkClicked?: (...args: any[]) => any;
}>, {
