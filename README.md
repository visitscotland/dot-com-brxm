...
1. **Navigate to the Jenkins instance**: https://jenkinssb.visitscotland.com/job/wvc/job/feature.visitscotland.com-delivery-api
2. **Locate the Relevant Job**: Go to the Pull Requests tab and Find the job whose name matches your GitHub PR number.
3. **Open the Environment Details**: In the job sidebar, click VS Environment Details. Alternatively this information can 
   be found at the bottom of the Console log. 
4. **Access the Integrated Environment**: On the Environment Details page, the first link provides access to the 
